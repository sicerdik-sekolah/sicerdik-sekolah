  ...
  return (
    <div className="borang" style={{ backgroundColor: "white" }}>
      ...
      <div className="titleBorang text-center d-flex flex-column justify-content-center align-items-center">
        <p className="title text-center mt-2">SURAT KETERANGAN PINDAH RAYON</p>
      ...
      <div className="content d-flex flex-column justify-content-start  mx-5">
        <p>
          &emsp;&emsp;&emsp;&emsp;Sesuai dengan surat permohonan pindah sekolah
        ...
        <p style={{ textAlign: "justify" }}>
          &emsp;&emsp;&emsp;&emsp;Dengan ini menerangkan bahwa nama tersebut di
          atas benar bersekolah di {props.data.asal_sekolah} Tanjungpinang
          Provinsi Kepulauan Riau dan telah lulus pada {props.data.tahun_lulus},
          akan melanjutkan ke {props.data.tujuan_sekolah}.{" "} <br />
          &emsp;&emsp;&emsp;&emsp;Demikian Surat keterangan ini dibuat untuk
