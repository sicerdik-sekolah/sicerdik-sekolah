...
export const createLaporan = createAsyncThunk(
  ...
  async (payload) => {
    ...
    console.log('>>>>>surat_dinas_pendidikan_setempat', payload.surat_rekomendasi_dinas_setempat)
    ...
    console.log(">>>>>kelurahan_tujuan_sekolah", payload.kelurahan_tujuan_sekolah)
    console.log(">>>>>kecamatan_tujuan_sekolah", payload.kecamatan_tujuan_sekolah)
    console.log(">>>>>kabupatenKota_tujuan_sekolah", payload.kabupatenKota_tujuan_sekolah)
    console.log(">>>>>provinsi_tujuan_sekolah", payload.provinsi_tujuan_sekolah)
    ...
    formData.append('surat_dinas_pendidikan_setempat', payload.surat_rekomendasi_dinas_setempat)
    ...
    formData.append("kelurahan_tujuan_sekolah", payload.kelurahan_tujuan_sekolah)
    formData.append("kecamatan_tujuan_sekolah", payload.kecamatan_tujuan_sekolah)
    formData.append("kabupatenKota_tujuan_sekolah", payload.kabupatenKota_tujuan_sekolah)
...
export const updateNaskahTelahTTDKepsek = createAsyncThunk(
  ...
  async (payload) => {
    ...
    //   },
    // })
    const res = await axios.put(`${apiPath}/cms/laporan/update-surat-ttd-kepsek/${payload.id}`, formData, {
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': formData ? 'multipart/form-data' : 'application/json',
      },
